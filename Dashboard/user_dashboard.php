...
<body>
    <header class="top-nav">
        ...
        <div class="nav-right">
            <div class="user-menu">
                <img src="<?php echo htmlspecialchars($user['profile_image'] ?? 'default_avatar.jpg'); ?>" 
                    alt="Profile" 
                    class="user-avatar">
        ...
        <aside class="sidebar">
            <nav class="side-nav">
                ...
                <div class="nav-item-wrapper">
                    ...
                    <div class="submenu">
                        <a href="http://localhost:6550" class="submenu-item">
                            <span class="nav-icon">📝</span>
                ...
                <div class="profile-card glass-card">
                    <div class="profile-header">
                        <!-- <img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=300&q=80" alt="Profile Picture" class="profile-image">
                         -->
                        <img src="default_avatar.jpg" alt="Profile" class="user-avatar">
